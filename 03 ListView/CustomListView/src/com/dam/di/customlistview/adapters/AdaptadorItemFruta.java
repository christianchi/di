package com.dam.di.customlistview.adapters;
...
import com.dam.di.customlistview.activities.ItemFruta;
	...
	public class AdaptadorItemFruta extends ArrayAdapter<ItemFruta>{
		...
		public AdaptadorItemFruta(Activity context,  ArrayList<ItemFruta> listaItem) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			icono.setImageResource(itemFruta.getImagen());
