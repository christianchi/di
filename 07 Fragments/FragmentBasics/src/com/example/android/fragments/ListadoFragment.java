...
public class ListadoFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Utilizamos diferentes layout para el listado de elementos, en función
        // de la versión de Android en la que estemos.
        // La plantilla definida en Android: simple_list_item_activated_1
        // marca en color azul el elemento del ListView que se seleccione.
        int layout = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB ?
                android.R.layout.simple_list_item_activated_1: android.R.layout.simple_list_item_1;

        // Creamos un ArrayAdapter para el ListView con el array Headlines de la clase Ipsum
        setListAdapter(new ArrayAdapter<String>(getActivity(), layout, UsuarioItem.Usuarios));
    }
