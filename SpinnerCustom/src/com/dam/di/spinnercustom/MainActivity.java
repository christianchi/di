...
public class MainActivity extends Activity {
	...
	// Esto es, si en la primera posición de spinnerValues escribo "Enfadado"
	// es necesario que en la primera posición de total_images aparezca el icono de enfadado.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // interna que he definido más abajo para personalizar las opciones del desplegable
        // Es necesario pasarle como parámetro a MyAdapter el layout personalizado que hemos
        // diseñado: R.layout.custom_spinner y los valores que 
    ...
    public class MyAdapter extends ArrayAdapter<String> {
        ...
        // El método que implementa mi Vista personalizada de las opciones del Spinner
        // Mi método recibe la posición que ocupa el elemento en la lista de opciones
        // comenzando el primer elemento con el valor de posición = 0.
        //
        public View getCustomView(int position, View convertView,
                ViewGroup parent) {
        	
            LayoutInflater bombaDeAire = getLayoutInflater();
            // ¿De qué inflo el layout padre? Pues, de mi layout personalizado: R.layout.custom_spinner
            ...
            // a la posición en la que me encuentro del array spinnerValues
